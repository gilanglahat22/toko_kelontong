    ...
    <div class="container">
        <div class="navbar-header">
                ...
                <a class="navbar-brand home" href="index.php" data-animate-hover="bounce">
                    <class="hidden-xs">
                    <class="visible-xs"><span class="sr-only">go to homepage</span>
                </a>
                    ...
                    <div class="box" id="contact">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <ul>
                                    <li><strong><a href="mailto:">toko_ibuilah@mail.com</a></strong>
                                    </li>
                                </ul>
                            </div>
                            <!-- /.col-sm-4 -->
...
<script>
    function initialize() {
        var mapOptions = {
            zoom: 15,
            center: new google.maps.LatLng(-7.674651836251462, 110.77626865807188),
        ...
        var myLatLng = new google.maps.LatLng(-7.674651836251462, 110.77626865807188);
